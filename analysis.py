...
# =========================
# Plotting (Simplified: Exp. vs Ctrl.)
# =========================
def plot_means_plotly(long_df, outcome, title, filename_stub, results_dir, run_tag):
    # 1. 定義簡化後的英文映射
    LEGEND_MAP = {"A": "Exp. Group", "B": "Ctrl. Group"}
    COLOR_MAP = {"Exp. Group": "#B22222", "Ctrl. Group": "#74C0FC"} # 實驗組深紅，控制組淺藍
    DASH_MAP = {"Exp. Group": "solid", "Ctrl. Group": "dash"}     # 實驗組實線，控制組虛線
    ...
    fig = px.line(
        ...
        markers=True,
        title=title,
        category_orders={"Legend": ["Exp. Group", "Ctrl. Group"]}
    )
...
def main(xlsx_path: str):
    ...
    log("Step 7/7 產生視覺化圖表 (Exp. vs Ctrl.)...")
